...
export default function ShoppingList ( {fetchedShoppingList}: { fetchedShoppingList: ShoppingListType }) {
    
    // _________________________ ETATS _________________________
    const router = useRouter(); 
    const csrfToken = useCsrfToken();
    const [shoppingList, setShoppingList] = useState<ShoppingListType | null>(fetchedShoppingList);
    ...
    // Séparer les ingrédients seuls des ingrédients par repas
